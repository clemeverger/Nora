...
const PopupPrice = ({ setPage }: any) => {
  return (
    ...
    >
      ...
      <div
        id='popup-modal'
        className={'fixed align-middle top-0 left-0 right-0 z-50 p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full'}
      >
        <div className='relative w-full max-w-md max-h-full'>
          <div className='relative bg-white rounded-lg shadow '>
            ...
            <div className='p-4 text-center'>
              <h3 className='mb-4 mt-14 text-2xl font-normal text-primary_dark'>Abonne toi à Nora + pour accéder à cette fonctionnalité !</h3>
              <p className='text-primary_dark font-light mb-6'>
                Nora + : Libérez-vous des troubles menstruels, prenez soin de votre santé féminine et rejoignez notre communauté bien-être.
              </p>
              <div className='flex flex-col space-y-2 mb-8'>
                <div className='bg-primary_light flex rounded-2xl p-2.5 space-x-3'>
                  ...
                  <div className='flex flex-col text-start'>
                    <p className='bg-white rounded-lg py-1.5  px-2 text-sm text-center max-w-max mb-2'>7 jours d’essai gratuit</p>
                    <p className='text-primary_dark text-sm mb-1'>Formule annuelle</p>
                    <p className='text-primary_dark text-sm font-light'>Facturation : 39,99 € à 12 mois</p>
                  </div>
                </div>
                <div className='bg-white flex rounded-2xl p-2.5 space-x-3 border'>
                  ...
                  <div className='flex flex-col space-y-1 text-start'>
                    ...
                    <p className='text-primary_dark text-sm font-light'>Facturation mensuelle, pas d’essai gratuit</p>
                  </div>
                </div>
              </div>
              <button
