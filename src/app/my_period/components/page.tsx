  ...
  return (
    ...
    >
      ...
      <div
        id="popup-modal"
        className={
          "fixed align-middle top-0 left-0 right-0 z-50 p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full"
        }
      >
              ...
              <div className="flex flex-col space-y-2 mb-8">
                ...
                <div className="bg-white flex rounded-2xl p-2.5 space-x-3 border">
                  ...
                  <div className="flex flex-col space-y-1 text-start">
                    <p className="text-primary_dark text-sm">
                      Formule mensuelle
                    </p>
                    <p className="text-primary_dark text-sm font-light">
